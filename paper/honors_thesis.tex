...
Overall, given the differing results
between the two state-indicator-adjusted models,
it is difficult to say whether there is any true spatial
variation in the responses,
especially given that the primary model group residuals
did not show spatial variation.
