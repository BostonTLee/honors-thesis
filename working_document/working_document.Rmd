...
MDE_resid_map <- map_var(map_resid_model_df, "prop_MDE_resid")
ggsave(paste("./maps/", "prop_MDE_resid.png", sep = ""), MDE_resid_map)
suicidal_thoughts_resid_map <- map_var(map_resid_model_df, "prop_suicidal_thoughts_resid")
ggsave(paste("./maps/", "prop_suicidal_thoughts_resid.png", sep = ""), suicidal_thoughts_resid_map)
alcohol_use_disorder_resid_map <- map_var(map_resid_model_df, "prop_alcohol_use_disorder_resid")
ggsave(paste("./maps/", "prop_alcohol_use_disorder_resid.png", sep = ""), alcohol_use_disorder_resid_map)
```
...
MDE_resid_adj_map <- map_var(map_resid_adj_model_df, "prop_MDE_resid")
ggsave(paste("./maps/", "prop_MDE_adj_resid.png", sep = ""), MDE_resid_adj_map)
suicidal_thoughts_resid_adj_map <- map_var(map_resid_adj_model_df, "prop_suicidal_thoughts_resid")
ggsave(paste("./maps/", "prop_suicidal_thoughts_adj_resid.png", sep = ""), suicidal_thoughts_resid_adj_map)
alcohol_use_disorder_resid_adj_map <- map_var(map_resid_adj_model_df, "prop_alcohol_use_disorder_resid")
ggsave(paste("./maps/", "prop_alcohol_use_disorder_adj_resid.png", sep = ""), alcohol_use_disorder_resid_adj_map)
```
