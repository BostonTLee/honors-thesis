...
summarize_data <- function(df) {
  ...
  min_df,
  median_df,
  max_df) %>% reduce(inner_join, by = "col_name")
...
write.csv(model_with_income_df, "../data/preprocessed/reduced.csv")
```
...
MDE_fitted_map <- map_var(map_fitted_model_df, "prop_MDE_fitted")
ggsave(paste("./maps/", "prop_MDE_fitted.png", sep = ""), MDE_fitted_map)
suicidal_thoughts_fitted_map <- map_var(map_fitted_model_df, "prop_suicidal_thoughts_fitted")
ggsave(paste("./maps/", "prop_suicidal_thoughts_fitted.png", sep = ""), suicidal_thoughts_fitted_map)
alcohol_use_disorder_fitted_map <- map_var(map_fitted_model_df, "prop_alcohol_use_disorder_fitted")
ggsave(paste("./maps/", "prop_alcohol_use_disorder_fitted.png", sep = ""), alcohol_use_disorder_fitted_map)
